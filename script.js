...
/***/ "./src/js/modules/elementsAnim.js":
/*!****************************************!*\
  !*** ./src/js/modules/elementsAnim.js ***!
  \****************************************/
/***/ ((__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "animateElem": () => (/* binding */ animateElem)
/* harmony export */ });
function animateElem() {
  ...
  hiddenElem.forEach((elem) => hiddenElemObserver.observe(elem));
}
...
function form() {
  ...
  form.addEventListener("submit", (e) => {
    ...
    axios__WEBPACK_IMPORTED_MODULE_0__["default"].post("#", formDataJson)
      .then(() => {
        modalTitle.textContent = "Thank you!";
        modalText.textContent = "I will contact you soon";
      })
      .catch(() => {
        modalTitle.textContent = "Something went wrong...";
        modalText.textContent = "Please, try again later or contact another way";
      })
      .finally(() => {
        form.reset();
        setTimeout(() => {
...
/***/ "./src/js/modules/progressRounds.js":
/*!******************************************!*\
  !*** ./src/js/modules/progressRounds.js ***!
  \******************************************/
/***/ ((__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */ });
/* harmony import */ var easy_pie_chart__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! easy-pie-chart */ "./node_modules/easy-pie-chart/dist/easypiechart.js");


function progress() {
  const charts = document.querySelectorAll(".skills__chart");
  ...
  const chartsObserver = new IntersectionObserver((entries) => {
    entries.forEach((entry) => {
      if (entry.isIntersecting) {
        ...
        elem.parentElement.style.boxShadow = `0px 0px 40px ${color}`;
        new easy_pie_chart__WEBPACK_IMPORTED_MODULE_0__(elem, {
          size: 160,
          barColor: color,
          scaleLength: 0,
          lineWidth: 12,
  ...
  charts.forEach((elem) => chartsObserver.observe(elem));
}


/***/ }),

/***/ "./src/js/modules/textTyped.js":
/*!*************************************!*\
  !*** ./src/js/modules/textTyped.js ***!
  \*************************************/
/***/ ((__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "textTyped": () => (/* binding */ textTyped)
/* harmony export */ });
...
function textTyped() {
  ...
  const typed = new typed_js__WEBPACK_IMPORTED_MODULE_0__(".promo__text", options);
}
...
/* harmony import */ var _modules_textTyped_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./modules/textTyped.js */ "./src/js/modules/textTyped.js");
/* harmony import */ var _modules_elementsAnim_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/elementsAnim.js */ "./src/js/modules/elementsAnim.js");
/* harmony import */ var _modules_progressRounds_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modules/progressRounds.js */ "./src/js/modules/progressRounds.js");
...
(0,_modules_modal_js__WEBPACK_IMPORTED_MODULE_0__.modal)();
(0,_modules_form_js__WEBPACK_IMPORTED_MODULE_1__.form)();
(0,_modules_textTyped_js__WEBPACK_IMPORTED_MODULE_2__.textTyped)();
(0,_modules_elementsAnim_js__WEBPACK_IMPORTED_MODULE_3__.animateElem)();
(0,_modules_progressRounds_js__WEBPACK_IMPORTED_MODULE_4__.progress)();
