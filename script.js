...
function accordion() {
    document.querySelectorAll('.prices__accordion').forEach(elem => {
        elem.addEventListener('click', () => {
          let content = elem.nextElementSibling;
      
          if(content.style.maxHeight) {
            // document.querySelectorAll('.prices__accordion-content').forEach((el) => el.style.maxHeight = null);
...
function counter() {
  ...
  window.addEventListener('scroll', scrolledT);

  function scrolledT() {
    const d = document.querySelector('#achievement');
    let gPose = d.getBoundingClientRect().top,
    topWindow = document.body.scrollTop;

    if(gPose < topWindow + 610) {
      window.removeEventListener('scroll', scrolledT);
      console.log('e');
         document.querySelectorAll('.achievement__count').forEach(item => {
            item.classList.add('viz');
            let i = 1,
...
function showThanksModal(messageTitle, messageText) {
    _modal_js__WEBPACK_IMPORTED_MODULE_0__["default"].classList.add('modal__open');
    document.body.style.overflow = 'hidden';
    _modal_js__WEBPACK_IMPORTED_MODULE_0__["default"].querySelector('.modal__title').textContent = messageTitle;
    _modal_js__WEBPACK_IMPORTED_MODULE_0__["default"].querySelector('.modal__text').textContent = messageText;
}
    ...
    const obj = {
        positive: {
            title: 'Спасибо',
            message: 'Скоро мы с вами свяжемся!'
        },
        negative: {
        ...
        form.addEventListener('submit', (e) => {
          ...
          const formData = new FormData(form);
           ...
           fetch('mail.php', {
            ...
            if(res.ok) {
              showThanksModal(obj.positive.title, obj.positive.message);
            } else {
              console.log('not');
              throw new Error();
            }
          }).catch(() => {
            showThanksModal(obj.negative.title, obj.negative.message);
          }).finally(() => {
            form.reset();
            setTimeout(() => {
              _modal_js__WEBPACK_IMPORTED_MODULE_0__["default"].classList.remove('modal__open');
...
/* harmony import */ var imask__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! imask */ "./node_modules/imask/esm/index.js");
 ...
 try {
  let phone = document.querySelector('.callback__form-phone');

  var phoneMask = (0,imask__WEBPACK_IMPORTED_MODULE_0__["default"])(
    phone, {
    ...
    for(let i = 0; i < arrow.length; i++) {
      ...
      thisLink.classList.add('parent');
        ...
        thisLink.addEventListener('click', (e) => {
          subMenu.classList.toggle('open');
          thisArrow.classList.toggle('active__arrow');
...
function pausevideo() {
    document.querySelector('.swiper-button-next').addEventListener('click', () => {
        document.querySelectorAll('.reviews__slider-video video').forEach(item => {
          item.pause();
        });
      });
...
/* harmony default export */ __webpack_exports__["default"] = (pausevideo);
...
try {
    const swiper = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"]('.swiper', {
      modules: [swiper__WEBPACK_IMPORTED_MODULE_0__.Navigation, swiper__WEBPACK_IMPORTED_MODULE_0__.Pagination,  swiper__WEBPACK_IMPORTED_MODULE_0__.EffectFlip],
      loop: true,
...
/* harmony import */ var _modules_accordion_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./modules/accordion.js */ "./src/js/modules/accordion.js");
...
/* harmony import */ var _modules_counter_js__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./modules/counter.js */ "./src/js/modules/counter.js");
/* harmony import */ var _modules_form_js__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./modules/form.js */ "./src/js/modules/form.js");
/* harmony import */ var _modules_tabs_js__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./modules/tabs.js */ "./src/js/modules/tabs.js");
/* harmony import */ var _modules_modal_js__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./modules/modal.js */ "./src/js/modules/modal.js");
/* harmony import */ var _modules_pausevideo_js__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./modules/pausevideo.js */ "./src/js/modules/pausevideo.js");
...
try {
  (0,_modules_scroll_js__WEBPACK_IMPORTED_MODULE_7__["default"])();
  (0,_modules_accordion_js__WEBPACK_IMPORTED_MODULE_5__["default"])();
  (0,_modules_counter_js__WEBPACK_IMPORTED_MODULE_8__["default"])();
  (0,_modules_form_js__WEBPACK_IMPORTED_MODULE_9__["default"])();
  (0,_modules_tabs_js__WEBPACK_IMPORTED_MODULE_10__["default"])();
  (0,_modules_modal_js__WEBPACK_IMPORTED_MODULE_11__["default"])();
  (0,_modules_pausevideo_js__WEBPACK_IMPORTED_MODULE_12__["default"])();
} catch(e) {
console.log(e);
}
new wowjs__WEBPACK_IMPORTED_MODULE_0__.WOW().init();
(0,_modules_burger_js__WEBPACK_IMPORTED_MODULE_4__["default"])();
